...
namespace CursoAngularDotNet.Persistence
{
    public class EventoPersist : IEventoPersist
    {
        ...
        public EventoPersist(CursoAngularDotNetContext context)
        {
            _context = context;
            //_context.ChangeTracker.QueryTrackingBehavior = QueryTrackingBehavior.NoTracking; Para todos os metodos
        }
