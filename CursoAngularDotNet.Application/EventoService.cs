...
namespace CursoAngularDotNet.Application
{
    public class EventoService : IEventoService
    {
        ...
        public async Task<EventoDto[]> GetAllEventosByThemeAsync(string tema, bool includePalestrantes = false)
        {
            try
            {
                var eventos = await _eventoPersist.GetAllEventosByThemeAsync(tema, includePalestrantes);
                if (eventos == null) return null;
